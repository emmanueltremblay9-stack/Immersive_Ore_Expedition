...
$requiredFeatureEntries = @(
    ...
    "com/oblixorprime/ioe/worldgen/IoeMotherDepositReservation.class",
    "com/oblixorprime/ioe/worldgen/IoeExpeditionPlanPlacement.class",
    "com/oblixorprime/ioe/worldgen/IoeSiteQualityFallbackResolver.class",
